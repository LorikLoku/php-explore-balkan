<?php
    include "php/fetchNorthMacedoniaContent.php";
...
<body>
    ...
    <video src="../IW/video/Skopje, North Macedonia by Drone (4K) - Drone Dimension.mp4" autoplay loop playsinline muted></video>

    <header class="viewport-header">
        <h1>
            <?php echo $row['countryTitle1']; ?>
            <span style="font-size: 120px !important;"><?php echo $row['countryTitle2']; ?></span>
        </h1>
    </header>
    <div class="music">
        <audio controls>
                <source src="../IW/audio/Macedonia Folk Music.mp3" type="audio/mpeg">
